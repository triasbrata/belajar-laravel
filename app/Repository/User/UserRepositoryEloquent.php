...
class UserRepositoryEloquent implements RepositoryInterface
{
	...
	public function update($id,$request){
		...
		if(!$model->fill($request)->save()) throw new Exception("update fail in class ". static::class, 1);
		return $model;
	}
	...
	public function insert($request){
		...
		if(!$model->save()) throw new Exception("insert fail in class ". static::class, 1);
		return $model;
	}
